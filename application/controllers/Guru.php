	...
	public function add(){
		if($this->input->post('nama')){
			...
			if ($this->form_validation->run() == FALSE) {
				...
				$data=array(
					"id_guru" => $id,
					"nip"=>filter_string($this->input->post('nip',TRUE)),
				...
				$datalama = "";
				$databaru = $data['nip'].'<br>'.$data['nama_guru'].'<br>'.$data['alamat_guru'].'<br>'.$data['hp_guru'].'<br>'.$data['jenkel_guru'].'<br>'.$data['id_akses_guru'];
	...
	public function update(){
		if($this->input->post('id_')){
			...
			if ($this->form_validation->run() == FALSE) {
				...
				$datalama = $row['nip'].'<br>'.$row['nama_guru'].'<br>'.$row['alamat_guru'].'<br>'.$row['hp_guru'].'<br>'.$row['jenkel_guru'];
				$databaru = $update['nip'].'<br>'.$update['nama_guru'].'<br>'.$update['alamat_guru'].'<br>'.$update['hp_guru'].'<br>'.$update['jenkel_guru'];
