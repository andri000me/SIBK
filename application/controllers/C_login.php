  ...
  //       echo "<br>";
		...
		if (substr($username,0,2)=="AD") { // echo "Admin";
			...
			if ($jml==1) { // echo "login";
				...
				history('',$this->parents,'Login As '.$akses['nama_hak_akses'],$datalama,$databaru,'');

				$this->session->set_flashdata('success', 'Selamat Datang! <br>'.$user['nama_admin'].' As '.$akses['nama_hak_akses']);
			...
			if ($jml==1) { // echo "login";
				...
				// history($id_dikenai,$menu,$kegiatan,$datalama,$databaru,$idriwayat)
				history('',$this->parents,'Login As '.$akses['nama_hak_akses'],$datalama,$databaru,'');
				$this->session->set_flashdata('success', 'Selamat Datang! <br>'.$user['nama_guru'].' As '.$akses['nama_hak_akses']);
				redirect(site_url($this->mza_secureurl->setSecureUrl_encode('Dashboard','index')),'refresh');
			}else{
				$this->session->set_flashdata('error','Username atau Password anda salah!');
				redirect(site_url($this->mza_secureurl->setSecureUrl_encode($this->con,'index')),'refresh');		
			...
			if ($jml==1) { // echo "login";
				...
				// history($id_dikenai,$menu,$kegiatan,$datalama,$databaru,$idriwayat)
				history('',$this->parents,'Login As '.$akses['nama_hak_akses'],$datalama,$databaru,'');
				$this->session->set_flashdata('success', 'Selamat Datang! <br>'.$user['nama_ortu'].' As '.$akses['nama_hak_akses']);
				redirect(site_url($this->mza_secureurl->setSecureUrl_encode('Dashboard','index')),'refresh');
			}else{
				$this->session->set_flashdata('error','Username atau Password anda salah!');
				redirect(site_url($this->mza_secureurl->setSecureUrl_encode($this->con,'index')),'refresh');		
			...
			if ($jml==1) { 
				...
				// history($id_dikenai,$menu,$kegiatan,$datalama,$databaru,$idriwayat)
				history('',$this->parents,'Login As '.$akses['nama_hak_akses'],$datalama,$databaru,'');
				$this->session->set_flashdata('success', 'Selamat Datang! <br>'.$user['nama_siswa'].' As '.$akses['nama_hak_akses']);
				redirect(site_url($this->mza_secureurl->setSecureUrl_encode('Dashboard','index')),'refresh');
			}else{
				$this->session->set_flashdata('error','Username atau Password anda salah!');
				redirect(site_url($this->mza_secureurl->setSecureUrl_encode($this->con,'index')),'refresh');		
