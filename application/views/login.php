...
<script src="<?php echo base_url('assets_login/demo/demo.js') ?>"></script>
  <!-- Demo script -->  <!-- / Demo script -->
    ...
    <div id="page-signin-bg">
        ...
        <!-- background -->
        <img  src="<?php echo base_url('UI/img/logo/bk_background.jpg') ?>" alt="">
    </div>
    <!-- / Page background -->
    ...
    <div class="signin-container">
        ...
        <div class="signin-info">
            <center> <img src="<?php echo base_url('UI/img/logo/login.png') ?>" id="imglogo" width="100%">
            </center>
            <a href="<?php echo site_url('C_login') ?>" class="logo">
                SI-<span style="font-weight:100;">BK</span>
            </a> <!-- / .logo -->
            <div class="slogan">
