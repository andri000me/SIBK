 ...
 * @Last Modified time: 2017-06-30 13:34:20
 */
 -->
        ...
        <div class="widget-body">
            <table class="table table-striped table-bordered myTable" id="myTable">
                <thead>
                    <tr>
                        <th width="5%">No</th>
                        <th class="hidden-phone" width="15%" >NIP</th>
                        <th class="hidden-phone" width="25%" >Nama guru</th>
                ...
                <?php $no=0;foreach ($guru as $row) {$no++ ?>
                    <tr class="odd gradeX">
                        ...
                        <td class="center hidden-phone"><?php echo $row->nip; ?></td>
