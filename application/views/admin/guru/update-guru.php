 ...
 * @Last Modified time: 2017-06-30 14:53:49
 */
 -->
<!-- Modal -->
      ...
      <div class="modal-body">
         <!-- BEGIN FORM-->
             <div class="control-group ">
                <label for="firstname" class="control-label">NIP</label>
                <div class="controls">
                    <input class="span12 " onKeyPress="return isNumberKey(this)" name="nip" type="text" autocomplete="off" value="<?php echo $row['nip']; ?>"  />
                </div>
            </div>
            <div class="control-group ">
