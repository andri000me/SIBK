 ...
 * @Last Modified time: 2017-06-18 06:38:11
 */
 -->
<!-- Modal -->
<form class="cmxform form-horizontal" id="commentForm" method="post" action="<?php echo site_url('Kelas/add'); ?>">
      ...
      <div class="modal-body">
         <!-- BEGIN FORM-->
            <div class="control-group ">
                ...
                <div class="controls">
                    <input class="span12 " name="tingkatan" placeholder="ex: XI" type="text" autocomplete="off" required />
                </div>
            </div>
            <div class="control-group ">
                <label for="firstname" class="control-label">Nama Kelas</label>
                <div class="controls">
                    <input class="span12 " name="nama" placeholder="ex : Sebelas" type="text" autocomplete="off" required />
                </div>
            </div>
        <!-- END FORM-->
      </div>
