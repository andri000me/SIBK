 ...
 * @Last Modified time: 2017-06-29 16:25:31
 */
 -->
<!-- Modal -->
<form class="cmxform form-horizontal" id="commentForm" method="post" action="<?php echo site_url('jurusan/update'); ?>">
      ...
      <div class="modal-body">
         <!-- BEGIN FORM-->
            <div class="control-group ">
                ...
                <div class="controls">
                    <input class="span12 " name="nama" type="text" autocomplete="off" value="<?php echo $row['nama_jurusan']; ?>" required />
            ...
            <div class="control-group ">
                ...
                <div class="controls">
                    <input class="span12 " name="akronim" type="text" autocomplete="off" value="<?php echo $row['akronim_jurusan']; ?>" required />
                </div>
            </div>
        <!-- END FORM-->
      </div>
