 ...
 * @Last Modified time: 2017-06-18 20:40:22
 */
 -->
<!-- Modal -->
<form class="cmxform form-horizontal" id="commentForm" method="post" action="<?php echo site_url('Jurusan/add'); ?>">
      ...
      <div class="modal-body">
         <!-- BEGIN FORM-->
            <div class="control-group ">
                ...
                <div class="controls">
                    <input class="span12 " name="nama" placeholder="ex: Rekayasa Perangkat Lunak" type="text" autocomplete="off" required />
                </div>
            </div>
            <div class="control-group ">
                <label for="firstname" class="control-label">Akronim Jurusan</label>
                <div class="controls">
                    <input class="span12 " name="akronim" placeholder="ex: RPL" type="text" autocomplete="off" required />
                </div>
            </div>
        <!-- END FORM-->
      </div>
