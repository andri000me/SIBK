 ...
 * @Date:   2017-06-12 10:15:48
 * @Last Modified by:   Moch Faizal Ansyori
 * @Last Modified time: 2017-07-09 21:33:39
 */
 -->
    ...
    <div class="metro-nav">
        ...
        <div class="metro-nav-block nav-block-red double">
            <a data-original-title="" href="#">
                ...
                <div class="status">Pelanggaran Siswa</div>
            </a>
        </div>
        <?php 
    ...
    <div class="span7">
        ...
        <div class="widget purple">
            <div class="widget-title">
                <h4><i class="icon-unlock-alt"></i> PELANGGARAN YANG SERING DILAKUKAN</h4>
                        <span class="tools">
