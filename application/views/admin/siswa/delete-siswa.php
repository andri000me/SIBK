 ...
 * @Last Modified time: 2017-07-05 18:47:20
 */
 -->
<!-- Modal -->
      ...
      <div class="modal-body">
         <!-- BEGIN FORM-->
            <div class="control-group ">
                ...
                <div class="controls">
                    <label class="control-label" style="font-weight: bold;">: <?php echo $row['nis_siswa']; ?></label>
                </div>
            </div>
            <div class="control-group ">
                <label for="firstname" class="control-label">Nama siswa</label>
                <div class="controls">
                    <label class="control-label" style="font-weight: bold;">: <?php echo $row['nama_siswa']; ?></label>
